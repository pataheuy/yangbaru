...
const proyekData = [
    ...
    { no: 4,  title: 'Revourner 17',                                    kategori: 'Event',                 cover: '/foto/revourner.png',          link: '/revourner17/index.html',      category: 'web',     best: true,  desc: 'Landing page acara tahunan SMPIT As-Syifa. Didesain penuh semangat untuk menyambut angkatan ke-17.' },
    ...
    // --- Web Apps ---
    { no: 7,  title: 'PufutaraOS',           titlePrefix: 'Pufutara', kategori: 'OS',                     cover: '/foto/os.png',          link: '/os/index.html',                                          category: 'web',     desc: 'Sistem operasi modern berbasis web. Cita-cita Putra waktu kecil akhirnya terwujud di PC Labkom!' },
    ...
    { no: 10, title: 'PufutaraTube',          titlePrefix: 'Pufutara', kategori: 'Media',                  cover: '/foto/tube.png',         link: '/tube/index.html',                                        category: 'web',     desc: 'Tempat nonton video favorit tanpa iklan yang mengganggu fokus koding kamu.' },
    { no: 11, title: 'PufutaraChat',          titlePrefix: 'Pufutara', kategori: 'Comm',                   cover: '/foto/chat.png',         link: '/chat/index.html',                                        category: 'web',     desc: 'Obrolan Simple, tambah akun, login, langsung chat ke semua orang secara real-time.' },
    { no: 12, title: 'PufutaraDrive',         titlePrefix: 'Pufutara', kategori: 'Cloud',                  cover: '/foto/cloud.png',        link: '/drive/index.html',                                       category: 'web',     desc: 'Simpan file-file penting proyek kodingan kamu dengan aman dan mudah diakses di mana saja.' },
    { no: 13, title: 'PufutaraGallery',       titlePrefix: 'Pufutara', kategori: 'Fullstack',              cover: '/foto/image.png',        link: '/gallery/index.html',                                     category: 'web',     desc: 'Proyek Full Stack pertama Putra! Upload foto otomatis tersimpan ke server untuk dilihat semua orang.' },
    ...
    { no: 32, title: 'Pufutara Shop',         titlePrefix: 'Pufutara', kategori: 'Store',                  cover: '/foto/shop.png',         link: '/shop/index.html',                                        category: 'web',     desc: 'Toko merchandise resmi Pufutara. Dukung terus karya lokal.' },
    ...
    { no: 36, title: 'PufutaraCBT',                                     kategori: 'Concept',               cover: '/foto/sarankritik.png',  link: 'cbt/index.html',                                          category: 'web',     desc: 'CBT bersih dan aman! gaperlu pakai exam browser lagi! otoamtis fullscreen! dan kalo keluar otomatis di Ban.' },
    { no: 37, title: 'Online Order System',                             kategori: 'E-Commerce',            cover: '/foto/onlineorder.png',  link: '/onlineorder/index.html',                                 category: 'web',     desc: 'Sistem pemesanan online modern dan praktis. Kelola pesanan, menu, dan transaksi dengan mudah!' },
    { no: 38, title: 'DepDik Putra Web V2',                             kategori: 'Departement',           cover: '/foto/depdikputrawebv2.png',   link: '/depdikputrawebv2/index.html', category: 'web',     desc: 'Versi kedua web Departemen Pendidikan BEM As-Syifa 2025/2026. Lebih modern, lebih lengkap.' },
];
...
(function () {
    ...
    function startStatChain() {
        ...
        // Tunggu signal dari index.html (flyback h1 selesai), lalu langsung mulai stats
        function run() {
        ...
        // Jika opening sudah selesai (returning visitor), run langsung
        // Jika belum, daftarkan sebagai callback yang dipanggil flyback
        if (sessionStorage.getItem('pufutara_intro_shown')) {
            // returning visitor: semua sudah instant, skip animasi stats
            return;
        } else {
